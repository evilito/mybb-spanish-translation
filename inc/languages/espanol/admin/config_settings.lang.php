...
$l['setting_seourls_archive'] = "Activar sistema de URLs amigables en el Modo Ligero (Engine friendly URLs)";
$l['setting_seourls_archive_desc'] = "Las URLs amigables pueden usarse en el modo ligero. <strong>Una vez activado este ajuste, debes asegurarte de que funciona correctamente.";
